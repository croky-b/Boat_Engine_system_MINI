...
const uint8_t RECEIVER_PINS[RECEIVER_CHANNELS_NUM]  = {13, 12, 14, 27, 33, 35, 34, 39 };
...
#define COMMAND_RX  36
#define COMMAND_TX  39
#endif
...
statusLED Led3(false);
statusLED Led4(false);
statusLED Led5(false);
statusLED Motor1(false);
...
*/
  ...
  monServo1.setPin(17, 0, 2, 0); //pin unit(0,1) timer(0,1,2)  channel(0,1) // timer0 conflic i2c ??
 
  Servo1.attach(17, 0, 2, 0);
  ...
  monServo2.setPin(16, 0, 0, 1); //pin unit(0,1) timer(0,1,2)  channel(0,1) // timer0 conflic i2c ??
  Servo2.attach(16, 0, 0, 1);

 
  ESC1.attach(15, 1, 0, 0);
  ESC2.attach(18, 1, 1, 1);
  ESC3.attach(32, 1, 2, 0);


  Led1.begin (2, 6, 20000);
  Led2.begin (4, 7, 20000);
  Led3.begin (5, 14, 20000);
  Led4.begin (19, 15, 20000);
  Led5.begin (3, 13, 20000);
  Motor1.begin (23, 12, 20000);
